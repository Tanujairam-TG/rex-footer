    ...
    try:
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("Updates", url="https://t.me/REX_BOTZ"), InlineKeyboardButton("Support group", url="https://t.me/REX_Bots_Support"), InlineKeyboardButton("Settings", url=f"https://t.me/{temp.U_NAME}?start=settings')]
                ]
            ),
            quote=True
        )
