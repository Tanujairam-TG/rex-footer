    ...
    try:
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("Updates", url="https://t.me/REX_BOTZ"), InlineKeyboardButton("Support group", url="https://t.me/REX_Bots_Support"), InlineKeyboardButton("Settings", callback_data='ShowSettins')]
                ]
            ),
            quote=True
        )
